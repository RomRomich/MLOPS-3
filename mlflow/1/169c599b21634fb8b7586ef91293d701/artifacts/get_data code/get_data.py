...
os.environ["MLFLOW_REGISTRY_URI"] = "/home/admin123/xFlow/mlflow/"
...
with mlflow.start_run():
    ...
    mlflow.log_artifact(local_path="/home/admin123/xFlow/scripts/get_data.py",
                        artifact_path="get_data code")
    mlflow.end_run()
 
with open('/home/admin123/xFlow/datasets/data.csv', 'a') as f:
    f.write("{}\n".format(s))
